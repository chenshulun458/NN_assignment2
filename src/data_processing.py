...
if __name__ == "__main__":
    ...
    corr=visualize_data(merged_data)
    plot_top_two_correlated_features(corr,abalone)
    plot_top_two_features_and_target_histograms(corr, abalone)
